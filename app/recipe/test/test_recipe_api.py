...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title="Thia Vegitable Curry")
        ...
        self.assertNotIn(s3.data, rest.data)

    def test_filter_by_ingredients(self):
        """Test filting recipe by ingredients."""
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".jpg") as image_file:
            ...
            # Saving the tempfile to img
            img.save(image_file, format="JPEG")

            # Going back to the begining of the file, enable to upload the file
            image_file.seek(0)

            # Payload to upload to the endpoint
